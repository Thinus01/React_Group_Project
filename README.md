...
**[Space Travelers' Hub]** web application for a company that provides commercial and scientific space travel services, using real live data from the SpaceX API. The application allows users to book rockets and join selected space missions.
...
- **[The application allows users to book rockets]**
